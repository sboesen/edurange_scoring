  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved attempt as @attempt" do
        ...
        post :create, {:attempt => { "user_id" => "invalid value" }}, valid_session
        assigns(:attempt).should be_a_new(Attempt)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested attempt" do
        ...
        Attempt.any_instance.should_receive(:update_attributes).with({ "user_id" => "1" })
        put :update, {:id => attempt.to_param, :attempt => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the attempt as @attempt" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Attempt.any_instance.stub(:save).and_return(false)
        put :update, {:id => attempt.to_param, :attempt => { "user_id" => "invalid value" }}, valid_session
        assigns(:attempt).should eq(attempt)
      end
